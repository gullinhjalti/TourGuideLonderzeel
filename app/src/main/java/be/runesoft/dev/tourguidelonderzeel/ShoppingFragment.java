...
public class ShoppingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        venues.add(new Venue(R.drawable.de_linde, "Meubelen De Linde", "Furniture store.", "Linde 45"));
        venues.add(new Venue(R.drawable.sarens, "Sarens", "Household appliances.", "Mechelsestraat 31"));
        venues.add(new Venue(R.drawable.colruyt, "Colruyt", "Supermarket.", "Molenstraat 39"));
        venues.add(new Venue(R.drawable.top_office, "Top Office Shop", "Office supply store.", "Molenstraat 11"));
